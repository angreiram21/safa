...
/** PRD upper exclusive f_core bound for a non-degenerate mixed basin. */
 ...
 * mean f_core: PRD, P, and PR all require 0.1 < mean(f_core) < 0.99.
 * Among admissible basins, the largest connected
